...
%	of the disturbance space provided. The probabilities can be varied, but
%	the first two columns can't.
...
% Note: Since the cells are saved columnwise in a 1D vector, to move right 
%		or left you need to add/subtract M. 
